...
To get started with this image, pleae see the extended tutorial in the Documentation section: "[NextGen on CIROH-2i2c JupyterHub](products/ngiab/distributions/nextgen-2i2c/)"